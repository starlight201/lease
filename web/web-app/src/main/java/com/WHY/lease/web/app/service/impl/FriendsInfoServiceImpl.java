...
public class FriendsInfoServiceImpl extends ServiceImpl<FriendsInfoMapper, FriendsInfo> implements FriendsInfoService {
    ...
    @Override
    public void saveOrUpdateFriend(InformationVo informationVo) {
        FriendsInfo friendsInfo=new FriendsInfo(informationVo.getToId(),LoginUserHolder.getLoginUser().getUserId(),0);
